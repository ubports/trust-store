...
struct CORE_TRUST_DLL_PUBLIC Agent : public core::trust::Agent
{
    ...
    struct Configuration
    {
        ...
        // A function resolving the primary pid of an app with a PID.
        std::function<core::trust::Pid(const std::string&, core::trust::Pid)> primary_pid_resolver;
    };
    ...
    // Return the primary PID of an application instance by querying UAL.
    static std::function<core::trust::Pid(const std::string&, core::trust::Pid)> ual_get_primary_pid_resolver();
